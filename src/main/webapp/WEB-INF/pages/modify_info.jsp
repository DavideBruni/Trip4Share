                    ...
                    <form method="post" action="updateProfile">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input   class="form-control" id="inputFirstName" type="text" placeholder="Mario" name="firstName">
                            </div>
                            <!-- Form Group (last name)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputLastName">Last name</label>
                                <input   class="form-control" id="inputLastName" type="text" placeholder="Rossi" name="lastName">
                            </div>
                        </div>
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputOrgName">Email address</label>
                                <input   class="form-control" id="inputOrgName" type="email" placeholdere="Start Bootstrap" name="email">
                            </div>
                            <!-- Form Group (location)-->
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input   class="form-control" id="inputEmailAddress" type="text" name="languages">
                        </div>
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input   class="form-control" id="inputPhone" type="text" name="nationality">
                            </div>
                            <!-- Form Group (birthday)-->
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputBirthday">Birthdate</label>
                                <input   class="form-control" id="inputBirthday" type="date" name="birthday" placeholder="06/10/1988">
                            </div>
                        </div>
                        <!-- Save changes button-->
